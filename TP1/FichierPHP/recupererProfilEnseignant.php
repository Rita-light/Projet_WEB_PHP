<?php
require_once '../FichierPHP/verifierConnexionEnseignant.php'; // Vérifie que l'enseignant est connecté
...
$idEnseignant = $_SESSION['enseignant_id']; // Récupère l'ID de l'enseignant depuis la session
